...
class GenerationRequest(BaseModel):
    ...
    num_stories: Optional[int] = Field(None, ge=1, le=30, description="Number of stories (1-30, when multi-story)")
    ...
    # Exterior & Structure
    roof_type: str = Field(..., description="Roof type: Gable, Hip, Flat (Buildable), Flat (Non-buildable), Pitched")
    ...
    units_per_floor: Optional[int] = Field(None, ge=1, le=50, description="Number of apartment units per floor")
    num_floors: Optional[int] = Field(None, ge=1, le=50, description="Number of floors with apartment units")
    unit_bedrooms: Optional[int] = Field(None, ge=1, le=30, description="Bedrooms per apartment unit")
    unit_bathrooms: Optional[float] = Field(None, ge=0.5, le=30.0, description="Bathrooms per apartment unit")
    unit_kitchens: Optional[int] = Field(None, ge=1, le=20, description="Kitchens per apartment unit")
    unit_living_rooms: Optional[int] = Field(None, ge=1, le=20, description="Living rooms per apartment unit")
    # Cameroon
